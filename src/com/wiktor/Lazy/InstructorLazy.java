...
public class InstructorLazy {
    ...
    private List<CourseLazy> courseList;


    public void add(CourseLazy course) {
        if (courseList == null) {
    ...
    public List<CourseLazy> getCourseList() {
        return courseList;
    }

    public void setCourseList(List<CourseLazy> courseList) {
